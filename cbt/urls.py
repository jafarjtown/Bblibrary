...
urlpatterns = [
    ...
    path('courses/add/objectives/questions/<int:course>/', views.cbt_add_qs, name="cbt_add_qs"),
    path('courses/add/true-false/questions/<int:course>/', views.create_true_false_question, name="cbt_add_tr_qs"),
